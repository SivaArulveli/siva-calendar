...
export const TAMIL_YEARS_60: { en: string; ta: string }[] = [
  { en: "Prabhava", ta: "பிரபவ" },
  { en: "Vibhava", ta: "விபவ" },
  { en: "Sukla", ta: "சுக்ல" },
  { en: "Pramoda", ta: "பிரமோதூத" },
  { en: "Prachorpaththi", ta: "பிரசோற்பத்தி" },
  { en: "Aangirasa", ta: "ஆங்கீரஸ" },
  { en: "Srimukha", ta: "ஸ்ரீமுக" },
  { en: "Bhava", ta: "பவ" },
  { en: "Yuva", ta: "யுவ" },
  { en: "Dhaatu", ta: "தாது" },
  { en: "Eswara", ta: "ஈஸ்வர" },
  { en: "Bahudhanya", ta: "வெகுதானிய" },
  { en: "Pramathi", ta: "பிரமாதி" },
  { en: "Vikrama", ta: "விக்ரம" },
  { en: "Vishu", ta: "விஷு" },
  { en: "Chitrabhanu", ta: "சித்திரபானு" },
  { en: "Swabhanu", ta: "சுபானு" },
  { en: "Tarana", ta: "தாரண" },
  { en: "Parthiba", ta: "பார்த்திப" },
  { en: "Viya", ta: "விய" },
  { en: "Sarvajith", ta: "சர்வசித்து" },
  { en: "Sarvadhari", ta: "சர்வதாரி" },
  { en: "Virodhi", ta: "விரோதி" },
  { en: "Vikruthi", ta: "விக்ருதி" },
  { en: "Kara", ta: "கர" },
  { en: "Nandhana", ta: "நந்தன" },
  { en: "Vijaya", ta: "விஜய" },
  { en: "Jaya", ta: "ஜய" },
  { en: "Manmadha", ta: "மன்மத" },
  { en: "Dhunmuki", ta: "துன்முகி" },
  { en: "Hevilambi", ta: "ஹேவிளம்பி" },
  { en: "Vilambi", ta: "விளம்பி" },
  { en: "Vikari", ta: "விகாரி" },
  { en: "Sarvari", ta: "சார்வரி" },
  { en: "Plava", ta: "பிலவ" },
  { en: "Subhakrutu", ta: "சுபகிருது" },
  { en: "Sobhakrutu", ta: "சோபகிருது" },
  { en: "Krodhi", ta: "குரோதி" },
  { en: "Visvavasu", ta: "விசுவாவசு" },
  { en: "Parabhava", ta: "பராபவ" },
  { en: "Plavanga", ta: "பிலவங்க" },
  { en: "Kilaka", ta: "கீலக" },
  { en: "Saumya", ta: "சௌமிய" },
  { en: "Sadharana", ta: "சாதாரண" },
  { en: "Virodhikrutu", ta: "விரோதகிருது" },
  { en: "Paridhapi", ta: "பரிதாபி" },
  { en: "Pramadhisa", ta: "பிரமாதீச" },
  { en: "Aananda", ta: "ஆனந்த" },
  { en: "Rakshasa", ta: "ராட்சச" },
  { en: "Nala", ta: "நள" },
  { en: "Pingala", ta: "பிங்கள" },
  { en: "Kalayukti", ta: "காளயுக்தி" },
  { en: "Siddharthi", ta: "சித்தார்த்தி" },
  { en: "Raudri", ta: "ரௌத்திரி" },
  { en: "Durmathi", ta: "துர்மதி" },
  { en: "Dundubhi", ta: "துந்துபி" },
  { en: "Rudhrodhgaari", ta: "ருத்ரோத்காரி" },
  { en: "Raktakshi", ta: "ரக்தாட்சி" },
  { en: "Krodhana", ta: "குரோதன" },
  { en: "Akshaya", ta: "அட்சய" },
];
...
export function getTamilMonthStartDate(
  yearIndex: number,
  monthIndex: number,
  cycleOffset = 0,
): Date {
...
export function toTamilNumber(n: number): string {
  return String(n)
    .split("")
    .map((d) => TAMIL_DIGITS[parseInt(d, 10)] ?? d)
    .join("");
}
